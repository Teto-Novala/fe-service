...
export default function List({ data, token }) {
  ...
  return (
    <>
      <div className="group w-full p-2 rounded-lg hover:bg-slate-400 transition justify-between flex bg-slate-300">
        <>
      ...
      {show && (
        <>
          ...
          <div className="w-[85%] md:w-[60%] fixed top-0 mt-28 z-[99] rounded-md bg-main ">
            <div className="p-4 flex flex-col gap-y-5 relative">
